...
<form action="${pageContext.request.contextPath }/user/pwd" method="post">
<div class="login_padding" id="login_model">

  <h2>学号/账号</h2>
  <label>
    <input type="text" name="id" class="txt_input txt_input2" placeholder="学号">
  </label>
  <h2>姓名</h2>
  <label>
  ...
  <label>
   ...
   <h2>修改密码</h2>
 <label>
    <input type="password" name="pwd" id="userpwd" class="txt_input" placeholder="修改密码">
  </label>
 ...
 <div>${updatepwd }
  ...
  <div class="rem_sub">
    ...
    <label>
      <input type="submit" class="sub_button" name="button" id="button" value="确定" >
    </label>
  </div>
</div>
</form>

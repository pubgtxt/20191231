...
<form action="${pageContext.request.contextPath}/user/addouttalk">
<div class="login_boder2"style="height:400px">
<div class="login_padding" id="login_model">

  <h2>序号</h2>
  <label>
    <input type="text" name="userid" id="username" class="txt_input txt_input2"  value="${user.id } " readonly="readonly"/>
  </label>
  <h2>发布者姓名</h2>
  <label>
   ...
   <h2>公告标题</h2>
  <label>
    <input type="text" name="title"  class="txt_input" 
     />
  </label>
   <h2>公告内容</h2>
  <label>

...
<form action="${pageContext.request.contextPath }/user/addreader" method="post">
<div class="login_padding" id="login_model">

  <h2>账号</h2>
  <label>
    <input type="text"  name="id" id="username" class="txt_input txt_input2" >
  </label>
  <h2>姓名</h2>
  <label>
    <input type="text" name="name" id="userpwd" class="txt_input" >
  </label>
  <h2>身份证号</h2>
  <label>
    <input type="text" name="idcard" id="userpwd" class="txt_input" >
  </label>
   <h2>密码</h2>
  <label>
...
<div>${regmsg }
  ...
  <div class="rem_sub">
    ...
    <label>
      <input type="submit" class="sub_button" name="button" id="button" value="新增" >
    </label>
  </div>
</div>
</form>

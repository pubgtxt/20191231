	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>${word.words }</td>
				<td>${word.time }</td>
				<td ><c:if test="${user.part eq '0'}"><a href="${pageContext.request.contextPath}/user/delwords">删除</a></c:if>
				</td>
			</tr>
			</c:forEach>
		</tbody>
...
<tr align="center">
					<td colspan="7">第${wordspager.currentPage}页/共${wordspager.totalPage}页&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="${pageContext.request.contextPath}/user/allwords?nowone=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:if test="${wordspager.currentPage>1}">
										<a href="${pageContext.request.contextPath}/user/allwords?nowone=${wordspager.currentPage-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									</c:if>
									<c:if test="${wordspager.currentPage<wordspager.totalPage}">
										<a href="${pageContext.request.contextPath}/user/allwords?nowone=${wordspager.currentPage+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									</c:if>
									<a href="${pageContext.request.contextPath}/user/allwords?nowone=${wordspager.totalPage}">末页</a>
					</td>
				</tr>
</table>
 </div >

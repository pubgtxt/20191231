	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>${wantbook.time }</td>
				<td><a href="${pageContext.request.contextPath}/user/delwantbook?id=${wantbook.id }&anthor=${wantbook.anthor}">取消申请</a></td>
			</tr>
...
<tr align="center">
					<td colspan="7">第${wantpager.currentPage}页/共${wantpager.totalPage}页&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="${pageContext.request.contextPath}/user/mywantbook?nowone=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:if test="${wantpager.currentPage>1}">
										<a href="${pageContext.request.contextPath}/user/mywantbook?nowone=${wantpager.currentPage-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									</c:if>
									<c:if test="${wantpager.currentPage<wantpager.totalPage}">
										<a href="${pageContext.request.contextPath}/user/mywantbook?nowone=${wantpager.currentPage+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
									</c:if>
									<a href="${pageContext.request.contextPath}/user/mywantbook?nowone=${wantpager.totalPage}">末页</a>
					</td>
				</tr>
</table>
 </div >
